 ...
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |  ,<  |  .>  |  /?  |Enter |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | Alt  | GUI  |  \|  |  L1  |    Space    |  L2  | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTYMAC] = KEYMAP( \
   KC_TAB,    KC_Q, KC_W,               KC_E,       KC_R,  KC_T,    KC_Y,       KC_U,    KC_I,    KC_O,        KC_P,  KC_BSPC, \
   KC_ESC,    KC_A, KC_S,               KC_D,       KC_F,  KC_G,    KC_H,       KC_J,    KC_K,    KC_L,       COLON,  QUOTE, \
  KC_LSFT,    KC_Z, KC_X,               KC_C,       KC_V,  KC_B,    KC_N,       KC_M, KC_COMM,  KC_DOT,     KC_SLSH,   KC_ENT, \
  KC_LCTL, KC_LALT, KC_LGUI, KC_NONUS_BSLASH,    MO(_L1),     KC_SPC    ,    MO(_L2), KC_LEFT, KC_DOWN,       KC_UP,  KC_RGHT \
),
 ...
 */
 [_L2] = KEYMAP( \
      KC_SYSREQ,   KC_F9,  KC_F10,  KC_F11,      KC_F12, XXXXXXX, KC_NUMLOCK, KC_KP_7, KC_KP_8,   KC_KP_9, KC_KP_ASTERISK,     KC_BSPC, \
        ...
        _______, _______, _______, XXXXXXX,     XXXXXXX,        KC_SPC      , XXXXXXX, KC_KP_0, KC_KP_DOT,    KC_KP_MINUS,      _______ \
 ),
